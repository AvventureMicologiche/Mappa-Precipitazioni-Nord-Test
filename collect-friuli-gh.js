/**
 * collect-friuli-gh.js  —  GitHub Actions
 * Raccoglie precipitazioni giornaliere Friuli-Venezia Giulia
 * Fonte: Open-Meteo Archive (API pubblica)
 */
...
async function main() {
  console.log('=== collect-friuli-gh avviato ===');
